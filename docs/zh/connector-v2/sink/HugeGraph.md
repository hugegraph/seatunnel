...
| `sourceIdMapping` | Map<String, String> | 边必须 | - | 一个只包括边元素起始顶点id的相关映射，其中键是源字段名，值是 HugeGraph 中的目标属性名。    |
| `targetIdMapping` | Map<String, String> | 边必须 | - | 一个只包括边元素指向顶点id的相关映射，其中键是源字段名，值是 HugeGraph 中的目标属性名。    |
